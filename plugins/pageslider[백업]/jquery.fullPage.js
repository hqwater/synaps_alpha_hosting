	...
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.section').each(function(index){
			...
			//$(this).css('height', windowsHeight + '.9px');
		...
		*/		
		 ...
		 */
		$('article').on('click', '.controlArrow', function() {
		...
		*/
		...
		function addTableClass(element){
			element.addClass('table').wrapInner('<div class="tableCell" style="height:' + getTableHeight(element) + '.5px;" />');
		}
		...
		*/
		...
		/**
		* Creates a landscape navigation bar with dots for horizontal sliders. 수정
		*/
